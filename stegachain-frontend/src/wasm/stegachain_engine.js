/* @ts-self-types="./stegachain_engine.d.ts" */
 ...
 * @returns {number}
 */
export function capacity_bytes(width, height) {
    const ret = wasm.capacity_bytes(width, height);
    return ret >>> 0;
}
 ...
 * @returns {Uint8Array}
 */
export function embed(rgba, width, height, payload) {
    const ptr0 = passArray8ToWasm0(rgba, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(payload, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.embed(ptr0, len0, width, height, ptr1, len1);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
export function extract(rgba, width, height) {
    const ptr0 = passArray8ToWasm0(rgba, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.extract(ptr0, len0, width, height);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./stegachain_engine_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('stegachain_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
